...
console.log(picArray[0].image.medium)
// add your code here
...
const arti = document.querySelectorAll('article')
const dialog = document.querySelector('dialog')
const largeImage = document.querySelector('dialog>img')
for (let i = 0; i<arti.length; i++){
  arti[i].addEventListener('click',function(evt){
    largeImage.setAttribute('src',picArray[i].image.large)
    largeImage.setAttribute('alt',picArray[i].title)
    dialog.showModal()
  })
}
